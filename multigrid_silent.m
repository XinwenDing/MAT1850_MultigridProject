function u = multigrid_silent(discrete_Laplacian, restriction, b, n, gamma, u_init, nu1, nu2, smoothing_method, omega)
    % This function is identical with multigrid.m, but without printing
    % statement. It is used for timing only.
    ...
    if n == 4
        ...
        for j = 1 : gamma
            e = multigrid_silent(discrete_Laplacian, restriction, res, n/2, gamma, e_init, nu1, nu2, smoothing_method, omega);
        end
